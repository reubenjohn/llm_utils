...
- Clone your fork of this repo. `git clone git@github.com:YOUR_GIT_USERNAME/llm.git`
- Enter the directory `cd llm`
- Add upstream repo `git remote add upstream https://github.com/reubenjohn/llm`
